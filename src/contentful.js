  ...
  const createAssetData = assetData => {
    ...
    return {
      ...
      file: assetData.fields
        ? assetData.fields.file['en-GB'] || assetData.fields.file
        : null,
      title: assetData.fields
        ? assetData.fields.title['en-GB'] || assetData.fields.title
        : null,
    };
  };
...
const parseFields = fields => {
  ...
  Object.keys(fields).map(key => {
    ...
    const valueLang = isObject(value) ? value['en-GB'] : value;
...
export const createEntry = async (args, contentType) => {
  ...
  console.log('hmmmm', contentType, { fields: data})
